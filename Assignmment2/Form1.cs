...
Source=(local)\SQLEXPRESS;Initial Catalog=Northwind;Integrated Security=True");                 connection.Open(); 
                ...
                */
                var datasource = @"DESKTOP-T0EEFH0\SQLEXPRESS"; // Note: Removed unnecessary semicolon
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            SqlConnection connection = new SqlConnection(@"Data Source=DESKTOP-T0EEFH0\SQLEXPRESS;Initial Catalog=Northwind;Integrated Security=True");
            connection.Open();
        ...
        private void button3_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlCommand command = new SqlCommand();
                SqlConnection connection = new SqlConnection(@"Data Source=DESKTOP-T0EEFH0\SQLEXPRESS;Initial Catalog=Northwind;Integrated Security=True");
                var datasource = @"DESKTOP-T0EEFH0\SQLEXPRESS"; var database = "Northwind"; var thisUsername = Form2.Username; var thisPassword = Form2.Password;
                string connString = @"Data Source=" + datasource + ";Initial Catalog=" + database + ";Persist Security Info=True;User ID=" + thisUsername + ";Password=" + thisPassword;
                SqlConnection conn = new SqlConnection(connString); conn.Open();
